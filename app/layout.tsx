...
const componentTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  "/limit-card": { title: "Limit Card", subtitle: "Usage limit cards with circular utilization charts and color variants." },
  "/modal": { title: "Modal", subtitle: "Reusable modal with title prop, close button, and child-driven body content." },
  "/contact-card": { title: "Contact Card", subtitle: "Partner and email contact card with success, danger, and warning variants." },
  "/company-info-card": { title: "Company Info Card", subtitle: "Company information card with contact details, category badge, and edit action." },
  "/lead-card": { title: "Lead Card", subtitle: "Lead summary card with reusable approved, pending, and rejected states." },
  ...
  "/doc-select-card": { title: "Doc Select Card", subtitle: "Selectable document cards with icons and descriptions." },
...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const breadcrumbData = pathname !== "/" && componentTitles[pathname] 
    ? {
        title: componentTitles[pathname].title,
        subtitle: componentTitles[pathname].subtitle,
        backButton: "/",
      }
    : null;
